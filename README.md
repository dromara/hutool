![封面](http://www.hutool.cn/images/logo.jpg)

[![Version](https://img.shields.io/badge/version-4.1.2-brightgreen.svg)](http://search.maven.org/#search%7Cga%7C1%7Ca%3A%22hutool-all%22)
...
### Gradle
```
compile 'cn.hutool:hutool-all:4.1.2'
```
