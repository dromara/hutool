...
```
implementation 'org.dromara.hutool:hutool-all:6.0.0-M18'
```
...
- [Maven中央库](https://repo1.maven.org/maven2/org/dromara/hutool/hutool-all/6.0.0-M18/)
