...
public class SoapRequest {
	...
	private Map<String, String> xmlnsMap;
	/** 请求方法 */
	 ...
	 * @return this
	 */
	public SoapRequest init() {
		this.xmlnsMap = new HashMap<>();
		// this.xmlnsMap.put(XMLNS_SOAPENV, "http://schemas.xmlsoap.org/soap/envelope/");
		return this;
	}
	 ...
	 * @return xmlns字符串
	 */
	private CharSequence buildXmlns() {
		if (MapUtil.isEmpty(this.xmlnsMap)) {
			return StrUtil.EMPTY;
		}
		final StringBuilder builder = StrUtil.builder();
		for (Entry<String, String> entry : MapUtil.wrap(this.xmlnsMap)) {
