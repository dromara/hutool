...
public class MethodUtilTest {
	...
	public void getMethodsFromClassExtends() {
		...
		// getA属于本类
		Assertions.assertEquals("public void reflect.org.dromara.hutool.ReflectUtilTest$C2.getA()", methods[0].toString());
		// getB属于父类
		Assertions.assertEquals("public void reflect.org.dromara.hutool.ReflectUtilTest$C1.getB()", methods[1].toString());
		// getC属于接口中的默认方法
		Assertions.assertEquals("public default void reflect.org.dromara.hutool.ReflectUtilTest$TestInterface1.getC()", methods[2].toString());
	}
