...
public class MethodUtilTest {
	...
	public void getMethodsFromClassExtends() {
		...
		// getB属于父类
		Assertions.assertEquals("public void cn.hutool.core.reflect.ReflectUtilTest$C1.getB()", methods[1].toString());
		// getC属于接口中的默认方法
		Assertions.assertEquals("public default void cn.hutool.core.reflect.ReflectUtilTest$TestInterface1.getC()", methods[2].toString());
	}
