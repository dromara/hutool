...
public class CollUtilTest {
    ...
    public void intersectionTest2(){
        ...
        Collection<String> union = CollUtil.intersectionDistinct(null, list2);
        Assert.assertEquals(union, CollectionUtil.newArrayList());

        Collection<String> union2 = CollUtil.intersectionDistinct(list1,list2);
        Assert.assertEquals(union2, CollectionUtil.newArrayList("a","b","c","d"));
