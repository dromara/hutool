...
public class GanzhiTest {
	...
	public void getCyclicalYMDTest(){
		//通过公历构建
		final ChineseDate chineseDate = new ChineseDate(DateUtil.parseDate("1993-01-06"));
	...
	public void getCyclicalYMDTest3(){
		//通过公历构建
		final ChineseDate chineseDate = new ChineseDate(DateUtil.parseDate("2020-08-28"));
		final String cyclicalYMD = chineseDate.getCyclicalYMD();
	...
	public void getCyclicalYMDTest4(){
		//通过公历构建
		final ChineseDate chineseDate = new ChineseDate(DateUtil.parseDate("1905-08-28"));
		final String cyclicalYMD = chineseDate.getCyclicalYMD();
