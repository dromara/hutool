...
public class CollUtil {
    ...
    public static <T> Collection<T> intersectionDistinct(Collection<T> coll1, Collection<T> coll2) {
     ...
     */
    @SafeVarargs
    public static <T> Collection<T> intersectionDistinct(Collection<T> coll1, Collection<T> coll2, Collection<T>... otherColls) {

        Collection<T> result = intersectionDistinct(coll1, coll2);
