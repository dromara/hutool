...
public class CollUtil {
	 ...
	 */
	public static <T, K> AbstractMap.SimpleEntry<List<T>, List<T>> diff(Collection<T> coll1, Collection<T> coll2, Function<T, K> keyMapper) {
		Triple<List<T>, List<T>, List<Object>> triple = diff(coll1, coll2, keyMapper, keyMapper, null, null);
		return new AbstractMap.SimpleEntry<>(triple.getLeft(), triple.getMiddle());
	}
