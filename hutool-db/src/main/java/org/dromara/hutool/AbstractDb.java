...
import org.dromara.hutool.handler.*;
import org.dromara.hutool.lang.func.SerFunction;
import org.dromara.hutool.sql.*;
...
public abstract class AbstractDb<R extends AbstractDb<R>> extends DefaultConnectionHolder implements Serializable {
	 ...
	 * @throws DbRuntimeException SQL执行异常
	 */
	public List<Entity> findLike(final String tableName, final String field, final String value, final Condition.LikeType likeType) throws DbRuntimeException {
